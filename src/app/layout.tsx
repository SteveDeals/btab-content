...
export const metadata: Metadata = {
  ...
  description: 'Launch your online store in minutes without inventory, warehousing, or logistics. Access 52+ premium products, set your prices, and start selling today.',
